---
title: "TrueNAS: TrueNAS email alerts"
description: "TrueNAS TrueNAS email alerts and the Microsoft 365 SMTP AUTH shutdown: some models or versions, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# TrueNAS TrueNAS email alerts: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
- [What the error message means](../ERROR-MESSAGES.md) — if the TrueNAS device is reporting a code rather than a sentence
