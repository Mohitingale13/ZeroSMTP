---
title: "Synology: NAS notification email"
description: "Synology NAS notification email and the Microsoft 365 SMTP AUTH shutdown: check vendor advisory, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Synology NAS notification email: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
[Read the vendor's statement in full](https://kb.synology.com/en-us/DSM/help/DSM/AdminCenter/system_notification_email?version=7)  
