---
title: "Zabbix: email notifications"
description: "Zabbix email notifications and the Microsoft 365 SMTP AUTH shutdown: some models or versions, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Zabbix email notifications: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
[Read the vendor's statement in full](https://www.zabbix.com/documentation/7.4/en/manual/introduction/whatsnew)  
...
- [What the error message means](../ERROR-MESSAGES.md) — if the Zabbix device is reporting a code rather than a sentence
